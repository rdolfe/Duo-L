...
- Parcours A1 → C2 : 15 unités, 29 leçons, 6 tests de niveau, ~395 exercices. Chaque leçon mêle oral et **réflexion** (QCM de compréhension en anglais, « quelle phrase est correcte », petits calculs, pièges de traduction). Les exercices sont regroupés par type au sein de chaque leçon ; déblocage séquentiel des leçons, puis des niveaux via les tests.
