    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          LT("Good evening."),
          MC("« Good morning » se dit :", ["avant midi", "après midi", "le soir", "la nuit"], "avant midi"),
          FB("Good ___, see you tomorrow!", "night", "avant de dormir"),
          WT("À bientôt !", "see you soon", "see you later"),
          WO("How are you today?", "Comment vas-tu aujourd'hui ?"),
          MC("On veut souhaiter une bonne journée. On dit :", ["Have a nice day!", "Good night!", "Nice to meet you!", "See you later!"], "Have a nice day!"),
        ],
      },
      {
        title: "Se présenter",
        exercises: [
          ...
          LT("My name is John."),
          MC("Pour demander le prénom de quelqu'un :", ["What's your name?", "How old are you?", "Where do you live?", "Are you okay?"], "What's your name?"),
          FB("I come ___ France.", "from", "origine"),
          WT("Il a vingt-cinq ans.", "he is twenty five", "he is twenty-five"),
          WO("Nice to meet you, my name is Clara.", "Enchanté, je m'appelle Clara."),
          MC("« How do you do? » est :", ["une formule de politesse formelle", "une question sur ta santé", "une façon de dire au revoir", "une commande au restaurant"], "une formule de politesse formelle"),
        ],
      },
      {
        title: "La politesse",
        exercises: [
          ...
          MC("Pour demander à quelqu'un de répéter poliment :", ["Could you say that again, please?", "What?", "I don't care.", "Speak louder!"], "Could you say that again, please?"),
          FB("Thank you so ___!", "much", "remercier fortement"),
          WT("De rien, avec plaisir.", "you're welcome", "my pleasure", "not at all"),
          WO("Sorry, I didn't catch that.", "Désolé, je n'ai pas compris."),
          MC("On bouscule quelqu'un par accident. On dit :", ["I'm so sorry!", "Thank you!", "Goodbye!", "Please!"], "I'm so sorry!"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Pour appeler le serveur :", ["Excuse me!", "Thank you!", "Goodbye!", "Please wait!"], "Excuse me!"),
          FB("Can I see the ___, please?", "menu", "la carte"),
          WT("Je prendrai un jus d'orange.", "i'll have an orange juice", "i will have an orange juice", "i would like an orange juice"),
          WO("A large coffee, please.", "Un grand café, s'il vous plaît."),
          MC("Comment demander l'heure de fermeture ?", ["What time do you close?", "How much is it?", "Where is the exit?", "Can I pay now?"], "What time do you close?"),
        ],
      },
      {
        title: "Les nombres",
        exercises: [
          ...
          MC("Combien font « seven plus eight » ?", ["fifteen", "thirteen", "fourteen", "sixteen"], "fifteen"),
          FB("There are ___ days in a week.", "seven", "jours de la semaine", "7"),
          WT("Elle a trente ans.", "she is thirty", "she is thirty years old", "she's thirty"),
          WO("I have four brothers.", "J'ai quatre frères."),
          MC("« A dozen » signifie :", ["douze", "dix", "vingt", "cent"], "douze"),
        ],
      },
      {
        title: "La famille",
        exercises: [
          ...
          MC("La mère de ma mère est ma :", ["grandmother", "aunt", "cousin", "stepmother"], "grandmother"),
          FB("His wife's mother is his ___.", "mother-in-law", "belle-mère"),
          WT("J'ai deux enfants.", "i have two children", "i have two kids"),
          WO("She is my little sister.", "C'est ma petite sœur."),
          MC("« only child » signifie :", ["enfant unique", "petit enfant", "enfant sage", "enfant adoptif"], "enfant unique"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Pour demander si c'est loin :", ["Is it far from here?", "How much is it?", "What time is it?", "Can I sit here?"], "Is it far from here?"),
          FB("The post office is ___ the left.", "on", "à gauche"),
          WT("Continuez tout droit.", "go straight ahead", "continue straight ahead", "keep going straight"),
          WO("The bank is next to the pharmacy.", "La banque est à côté de la pharmacie."),
          MC("« at the crossroads » signifie :", ["au carrefour", "au marché", "à la gare", "à l'hôpital"], "au carrefour"),
        ],
      },
      {
        title: "À la gare",
        exercises: [
          ...
          MC("Pour demander la durée du trajet :", ["How long does the journey take?", "How much is the ticket?", "Where is the platform?", "What time does it leave?"], "How long does the journey take?"),
          FB("Is this seat ___?", "free", "libre / disponible", "taken"),
          WT("Le train est à l'heure.", "the train is on time"),
          WO("Two tickets to Paris, please.", "Deux billets pour Paris, s'il vous plaît."),
          MC("« single ticket » est :", ["un aller simple", "un aller-retour", "un abonnement", "une réservation"], "un aller simple"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Pour demander un réveil matin :", ["Can I have a wake-up call?", "Can I check out?", "Is breakfast included?", "Where is the gym?"], "Can I have a wake-up call?"),
          FB("My room ___ very noisy.", "is", "se plaindre du bruit"),
          WT("Y a-t-il une piscine ?", "is there a swimming pool", "do you have a swimming pool"),
          WO("I would like to extend my stay.", "Je voudrais prolonger mon séjour."),
          MC("« room service » signifie :", ["service en chambre", "ménage", "réception", "salle à manger"], "service en chambre"),
        ],
      },
      {
        title: "À l'aéroport",
        exercises: [
          ...
          MC("Pour savoir si son vol est à l'heure :", ["Is my flight on time?", "Where is the baggage claim?", "How long is the flight?", "Can I upgrade?"], "Is my flight on time?"),
          FB("My flight ___ delayed by two hours.", "is", "vol retardé"),
          WT("Mon billet est en classe économique.", "my ticket is economy class", "i'm flying economy"),
          WO("Do I need to check in online?", "Dois-je m'enregistrer en ligne ?"),
          MC("« hand luggage » est :", ["un bagage à main", "un grand bagage", "un sac de voyage", "une valise"], "un bagage à main"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Pour demander une réduction :", ["Do you have a discount?", "Can I try it on?", "Where is the fitting room?", "How much is this?"], "Do you have a discount?"),
          FB("I'll ___ it.", "take", "décision d'achat"),
          WT("Je cherche un cadeau.", "i am looking for a gift", "i'm looking for a present"),
          WO("Do you accept credit cards?", "Acceptez-vous les cartes de crédit ?"),
          MC("« sale » dans un magasin signifie :", ["soldes", "vente aux enchères", "fermeture", "remboursement"], "soldes"),
        ],
      },
      {
        title: "Au restaurant",
        exercises: [
          ...
          MC("Pour signaler une allergie :", ["I'm allergic to nuts.", "The food is cold.", "Can I have the menu?", "Where is the toilet?"], "I'm allergic to nuts."),
          FB("I'd like to book a table for ___ people.", "two", "réservation"),
          WT("C'est délicieux, compliments au chef !", "it's delicious compliments to the chef", "this is delicious please pass my compliments to the chef"),
          WO("Could we have some more bread, please?", "Pourrions-nous avoir encore du pain ?"),
          MC("« rare » pour un steak signifie :", ["saignant", "bien cuit", "à point", "très cuit"], "saignant"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« I'm into cooking » signifie :", ["J'aime cuisiner", "Je cuisine mal", "Je dois cuisiner", "Je cuisine souvent par obligation"], "J'aime cuisiner"),
          FB("I spend most of my free time ___ music.", "listening to", "écouter de la musique"),
          WT("Je préfère les sports d'équipe.", "i prefer team sports"),
          WO("I've been playing chess since I was eight.", "Je joue aux échecs depuis que j'ai huit ans."),
          MC("Lequel n'est pas un loisir créatif ?", ["jogging", "painting", "knitting", "photography"], "jogging"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Expression pour nuancer son avis :", ["To be honest,", "I disagree,", "In conclusion,", "First of all,"], "To be honest,"),
          FB("As ___ as I'm concerned, it's a great idea.", "far", "en ce qui me concerne"),
          WT("Ce n'est pas mon avis.", "that's not my opinion", "i don't agree with that", "i disagree"),
          WO("I strongly believe this decision is wrong.", "Je crois fermement que cette décision est mauvaise."),
          MC("Façon de demander l'avis de quelqu'un :", ["What do you think about it?", "I believe you're right.", "In my opinion...", "I disagree with you."], "What do you think about it?"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Pour décrire quelque chose d'ennuyeux :", ["It was pretty dull.", "It was a blast!", "It was fantastic!", "I had a great time!"], "It was pretty dull."),
          FB("We ___ a barbecue on Saturday.", "had", "avoir / organiser, au passé"),
          WT("On a regardé un match de foot.", "we watched a football match", "we watched a soccer game"),
          WO("We went for a long walk in the country.", "Nous avons fait une longue promenade à la campagne."),
          MC("Façon de dire qu'on n'a rien fait de spécial :", ["I just stayed at home and relaxed.", "It was a blast!", "I was very busy.", "We traveled abroad."], "I just stayed at home and relaxed."),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Comment parler de ses ambitions :", ["I'm looking for new challenges.", "I have no goals.", "I want more money.", "I dislike my current job."], "I'm looking for new challenges."),
          FB("I am a team ___ but I can also work independently.", "player", "travail en équipe"),
          WT("J'ai postulé à ce poste car il correspond à mon profil.", "i applied for this position because it matches my profile", "i applied for this job because it suits my profile"),
          WO("My greatest strength is my ability to adapt.", "Ma plus grande qualité est ma capacité d'adaptation."),
          MC("« Would you be available to start next Monday? » — réponse positive :", ["Absolutely, that works for me.", "I'm not sure I want the job.", "I prefer Fridays.", "Next year, perhaps."], "Absolutely, that works for me."),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Pour laisser un message :", ["Can I leave a message?", "I'll call back later.", "Are you there?", "Please hold."], "Can I leave a message?"),
          FB("I'm writing to ___ about your services.", "inquire", "se renseigner"),
          WT("Merci de confirmer la réception de cet e-mail.", "please confirm receipt of this email", "please confirm you have received this email"),
          WO("I'll get back to you by the end of the day.", "Je vous recontacterai avant la fin de la journée."),
          MC("Pour dire qu'on a eu quelqu'un en ligne :", ["I got through to him.", "I missed his call.", "He hung up.", "The line was busy."], "I got through to him."),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Façon polie de corriger quelqu'un :", ["I think there may be a slight misunderstanding.", "You're wrong.", "That's not true at all.", "I disagree completely."], "I think there may be a slight misunderstanding."),
          FB("With ___ respect, I must object.", "all due", "formule diplomatique"),
          WT("Je vois les choses différemment.", "i see things differently", "i see it differently"),
          WO("I'm afraid I can't go along with that.", "Je crains de ne pouvoir accepter cela."),
          MC("« to agree to disagree » signifie :", ["accepter d'avoir des opinions différentes", "finir par être d'accord", "refuser de discuter", "changer d'avis"], "accepter d'avoir des opinions différentes"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« admittedly » signifie :", ["certes / il est vrai que", "certainement", "finalement", "d'abord"], "certes / il est vrai que"),
          FB("___ the pros and cons, I'd say it's worth trying.", "weighing", "peser le pour et le contre"),
          WT("Il y a deux côtés à toute médaille.", "there are two sides to every coin", "there are two sides to every story"),
          WO("On balance, the benefits outweigh the drawbacks.", "Dans l'ensemble, les avantages l'emportent sur les inconvénients."),
          MC("Connecteur pour ajouter un argument :", ["furthermore", "however", "despite", "although"], "furthermore"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Pour présenter sa proposition clairement :", ["Allow me to outline our proposal.", "We want everything.", "Take it or leave it.", "This is not negotiable."], "Allow me to outline our proposal."),
          FB("We'd be prepared to ___ on the delivery date.", "compromise", "faire un compromis"),
          WT("C'est dans votre intérêt autant que dans le nôtre.", "it's in your interest as much as ours", "this benefits us both"),
          WO("Could we revisit the terms of the agreement?", "Pourrions-nous revoir les termes de l'accord ?"),
          MC("Pour clore une négociation positivement :", ["I think we have a deal.", "We'll think about it.", "I need more time.", "Let's start over."], "I think we have a deal."),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« I see you've been busy » dit avec ironie peut signifier :", ["Tu n'as rien fait", "Tu as beaucoup travaillé", "C'est impressionnant", "Dépêche-toi"], "Tu n'as rien fait"),
          FB("Oh, ___ genius plan that turned out to be.", "what a", "sarcasme"),
          WT("C'est exactement ce dont j'avais besoin. Merci infiniment. (ironique)", "just what i needed thank you so much", "that's exactly what i needed"),
          WO("How utterly predictable.", "Comme c'est prévisible."),
          MC("Understatement pour dire que quelque chose est catastrophique :", ["It could have gone a little better.", "It was perfect.", "I loved it.", "It was unforgettable."], "It could have gone a little better."),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Version formelle de « I want a refund » :", ["I would like to request a refund.", "Give me my money back.", "This is unacceptable.", "I'm angry."], "I would like to request a refund."),
          FB("I trust this ___ your requirements.", "meets", "j'espère que cela répond à vos besoins"),
          WT("Je vous prie d'agréer l'expression de mes salutations distinguées.", "yours sincerely", "yours faithfully"),
          WO("Perhaps we could find a more suitable arrangement.", "Peut-être pourrions-nous trouver un arrangement plus adapté."),
          MC("Registre neutre de « knackered » :", ["exhausted", "tired", "sleepy", "bored"], "exhausted"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Quelle figure de style : « We shall fight on the beaches, we shall fight on the landing grounds… » ?", ["une anaphore", "une métaphore", "une litote", "un oxymore"], "anaphore", "répétition en début de phrases"),
          ...
          MC("Une « litote » consiste à :", ["dire moins pour signifier plus", "exagérer à l'extrême", "répéter le même mot", "poser une question"], "dire moins pour signifier plus"),
          FB("The greatest speeches have one thing in common: ___.", "conviction", "la conviction"),
          WT("Permettez-moi de commencer par une citation.", "allow me to begin with a quote", "let me start with a quotation"),
          WO("Words have the power to move mountains.", "Les mots ont le pouvoir de déplacer des montagnes."),
          MC("Quelle figure rhétorique dans « It was the best of times, it was the worst of times » ?", ["une antithèse", "une métaphore", "une anaphore", "une hyperbole"], "une antithèse"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« to refute an argument » signifie :", ["réfuter un argument", "reformuler", "renforcer", "répéter"], "réfuter un argument"),
          FB("That argument commits the ___ man fallacy.", "straw", "homme de paille"),
          WT("Votre conclusion ne découle pas de vos prémisses.", "your conclusion does not follow from your premises", "your conclusion doesn't follow from your premises"),
          WO("Allow me to address each point in turn.", "Permettez-moi d'aborder chaque point à son tour."),
          MC("Le « slippery slope » (pente glissante) consiste à :", ["supposer qu'une action mène inévitablement à une conséquence extrême", "glisser sur scène", "utiliser des statistiques fausses", "ignorer l'adversaire"], "supposer qu'une action mène inévitablement à une conséquence extrême"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« Tom ___ in Paris. »", ["lives", "live", "living", "lived"], "lives", "3e personne"),
          FB("She ___ to the gym three times a week.", "goes", "3e personne, aller"),
          WT("Ils travaillent dans un bureau.", "they work in an office"),
          WO("He reads the newspaper every morning.", "Il lit le journal tous les matins."),
          MC("Which is correct?", ["She doesn't like spicy food.", "She don't like spicy food.", "She isn't like spicy food.", "She not like spicy food."], "She doesn't like spicy food."),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« He doesn't work on Fridays » — il travaille le vendredi ?", ["Non", "Oui", "Parfois", "On ne sait pas"], "Non"),
          FB("___ they speak French at home?", "do", "question avec they"),
          WT("Je ne sais pas.", "i don't know", "i do not know"),
          WO("Do you have any brothers or sisters?", "As-tu des frères ou des sœurs ?"),
          MC("Forme interrogative de « She likes coffee » :", ["Does she like coffee?", "Do she like coffee?", "Is she like coffee?", "She does like coffee?"], "Does she like coffee?"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Le passé de « write » est :", ["wrote", "writed", "written", "wrotes"], "wrote"),
          FB("We ___ at the hotel last Friday.", "arrived", "arriver, au passé"),
          WT("Il a perdu ses clés.", "he lost his keys"),
          WO("She called me yesterday afternoon.", "Elle m'a appelé hier après-midi."),
          MC("« Did she call? » — réponse négative :", ["No, she didn't.", "No, she wasn't.", "No, she hasn't.", "No, she don't."], "No, she didn't."),
          MC("Le passé de « meet » :", ["met", "meeted", "meet", "has met"], "met"),
          MC("« neighbor » signifie :", ["voisin", "quartier", "région", "banlieue"], "voisin"),
          MC("« always » est un adverbe de :", ["fréquence", "manière", "lieu", "temps précis"], "fréquence"),
          MC("Comment dit-on « boucherie » ?", ["butcher's", "bakery", "pharmacy", "newsagent's"], "butcher's"),
          MC("Le futur de « I go » est :", ["I'm going to go", "I went", "I gone", "I goes"], "I'm going to go"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« to commute » signifie :", ["faire le trajet domicile-travail", "communiquer", "commander", "se déplacer en avion"], "faire le trajet domicile-travail"),
          FB("I need to ___ a dentist appointment.", "make", "prendre rendez-vous"),
          WT("Il a perdu son emploi.", "he lost his job", "he was fired", "he got fired"),
          WO("She is looking for a new flat.", "Elle cherche un nouvel appartement."),
          MC("« run errands » signifie :", ["faire des courses/commissions", "courir vite", "travailler dur", "se lever tôt"], "faire des courses/commissions"),
        ],
      },
      {
        ...
        exercises: [
          ...
          LR("She could have called, but she didn't.", "Elle aurait pu appeler, mais elle ne l'a pas fait."),
          MC("« although » introduit :", ["une concession", "une cause", "une conséquence", "un exemple"], "une concession"),
          FB("I wish I ___ more time to travel.", "had", "souhait irréel"),
          WT("Bien qu'il soit fatigué, il a continué.", "although he was tired he continued", "even though he was tired he kept going"),
          WO("She hasn't seen him since last summer.", "Elle ne l'a pas vu depuis l'été dernier."),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« to be under the weather » signifie :", ["ne pas se sentir bien", "être dehors sous la pluie", "avoir trop chaud", "être perdu"], "ne pas se sentir bien"),
          FB("She's a bit ___ today; let her rest.", "off", "pas dans son assiette"),
          WT("Ça marche pour moi.", "that works for me", "works for me", "that's fine with me"),
          WO("It's on the tip of my tongue.", "Je l'ai sur le bout de la langue."),
          MC("« to give someone the benefit of the doubt » :", ["faire confiance malgré le doute", "donner une seconde chance", "punir quelqu'un", "ignorer quelqu'un"], "faire confiance malgré le doute"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("Complète : « It's high time we ___ a decision. »", ["made", "make", "will make", "would make"], "made", "it's high time + prétérit"),
          FB("He ___ rather take the train than fly.", "would", "would rather"),
          WT("Il est possible qu'il ait oublié.", "he may have forgotten", "he might have forgotten"),
          WO("She would have come if she had known.", "Elle serait venue si elle avait su."),
          MC("« Provided that » a le même sens que :", ["as long as", "despite", "although", "because"], "as long as"),
        ],
      },
      {
        ...
        exercises: [
          ...
          LR("The findings were inconclusive at best.", "Les résultats étaient tout au plus peu concluants."),
          MC("« to be on the verge of » signifie :", ["être sur le point de", "être au milieu de", "être loin de", "avoir peur de"], "être sur le point de"),
          FB("___ the circumstances, the outcome was surprisingly positive.", "given", "étant donné"),
          WT("Sa réponse laissait beaucoup à désirer.", "his answer left much to be desired", "her answer left a lot to be desired"),
          WO("The proposal was rejected without further discussion.", "La proposition a été rejetée sans autre discussion."),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Passif de « They will announce the results » :", ["The results will be announced.", "The results are announced.", "They are announced results.", "The results will announce."], "The results will be announced."),
          FB("It ___ generally accepted that exercise is good for you.", "is", "passif impersonnel"),
          WT("Des mesures ont été prises.", "measures have been taken", "steps have been taken"),
          WO("The suspects are believed to be dangerous.", "Les suspects seraient dangereux."),
          MC("« Mistakes were made » — qui est responsable ?", ["On ne sait pas", "Le locuteur", "Les managers", "Personne"], "On ne sait pas", "le passif évite de nommer le responsable"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« tenacious » signifie :", ["tenace", "tendu", "temporaire", "timide"], "tenace"),
          FB("The film was ___; nobody expected that twist.", "riveting", "captivant"),
          WT("Sa décision était à la fois courageuse et imprudente.", "his decision was both brave and reckless", "her decision was courageous yet reckless"),
          WO("The committee was deeply divided on the issue.", "Le comité était profondément divisé sur la question."),
          MC("Nuance entre « angry » et « furious » :", ["furious est plus fort", "ils sont identiques", "angry est plus fort", "furious est plus poli"], "furious est plus fort"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Collocation correcte avec « research » :", ["to conduct research", "to make research", "to do a research", "to run a research"], "to conduct research"),
          FB("She ___ a valid point in her presentation.", "raised", "soulever un point"),
          WT("L'accord a finalement été conclu.", "the agreement was finally reached", "the deal was eventually struck"),
          WO("His dedication to the project was beyond question.", "Son dévouement au projet était incontestable."),
          MC("La collocation correcte :", ["to reach a compromise", "to do a compromise", "to make a compromise", "to find a compromise"], "to reach a compromise"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« inscrutable » signifie :", ["impénétrable, mystérieux", "indescriptible", "incompétent", "indiscutable"], "impénétrable, mystérieux"),
          FB("His alibi proved to be entirely ___.", "fabricated", "fabriqué de toutes pièces"),
          WT("Ça va sans dire.", "it goes without saying", "needless to say"),
          WO("The verdict was met with widespread disbelief.", "Le verdict a suscité une incrédulité générale."),
          MC("« laconic » décrit quelqu'un qui :", ["parle peu mais avec précision", "parle beaucoup", "ment souvent", "est très poli"], "parle peu mais avec précision"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("Meilleure traduction de « Mieux vaut tard que jamais » :", ["Better late than never.", "It's too late.", "Never too late.", "Late is better."], "Better late than never."),
          FB("« L'habit ne fait pas le moine » : Don't judge a book ___ its cover.", "by", "expression idiomatique"),
          WT("La nuit porte conseil.", "sleep on it", "let's sleep on it"),
          WO("The pen is mightier than the sword.", "La plume est plus puissante que l'épée."),
          MC("Meilleure traduction de « avoir d'autres chats à fouetter » :", ["to have bigger fish to fry", "to have many cats", "to be very busy", "to prefer animals"], "to have bigger fish to fry"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« to assist » signifie :", ["aider", "assister à un spectacle", "asseoir", "participer"], "aider"),
          FB("This news is very ___. (décevant)", "disappointing", "pas « deceptive » !"),
          WT("Finalement, ils ont trouvé un accord.", "eventually they reached an agreement", "in the end they found an agreement"),
          WO("She is very sensitive, not sensible.", "Elle est très sensible, pas raisonnable."),
          MC("« to ignore someone » signifie :", ["ignorer quelqu'un volontairement", "ne pas savoir quelque chose", "ne pas reconnaître quelqu'un", "saluer quelqu'un"], "ignorer quelqu'un volontairement"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« book » signifie :", ["livre", "cuisinier", "pain", "tasse"], "livre"),
          MC("Comment dit-on « j'ai chaud » ?", ["I'm hot", "I'm warm me", "I have hot", "I feel hot of"], "I'm hot"),
          MC("Le contraire de « old » est :", ["young", "new", "fast", "cold"], "young"),
          MC("« run » signifie :", ["courir", "marcher", "sauter", "nager"], "courir"),
          MC("Quel animal fait « moo » ?", ["cow", "dog", "cat", "sheep"], "cow"),
        ],
      },
      {
        title: "QCM modérés",
        exercises: [
          ...
          MC("« I ___ a shower every morning. »", ["take", "do", "make", "have"], "take", "take a shower"),
          MC("« this » vs « these » : « ___ shoes are mine. »", ["these", "this", "those one", "that"], "these"),
          MC("Read: « Sue has a black cat and a white dog. » — How many pets?", ["two", "one", "three", "four"], "two"),
          MC("Le contraire de « open » :", ["closed", "close", "closing", "closure"], "closed"),
          MC("« He's got a headache » signifie :", ["Il a mal à la tête", "Il est content", "Il a faim", "Il est enrhumé"], "Il a mal à la tête"),
        ],
      },
      {
        ...
        exercises: [
          ...
          MC("« a bit of » s'utilise avec :", ["un nom indénombrable", "un nom pluriel", "un nom propre", "un adjectif"], "un nom indénombrable"),
          MC("Quelle heure est « quarter to six »?", ["5 h 45", "6 h 15", "5 h 15", "6 h 45"], "5 h 45"),
          MC("« I'd like » est la contraction de :", ["I would like", "I did like", "I had liked", "I shall like"], "I would like"),
          MC("Read: « The library is between the bank and the park. » — La bibliothèque est entre…", ["la banque et le parc", "la gare et la banque", "le parc et le musée", "la pharmacie et la banque"], "la banque et le parc"),
          MC("Quelle phrase utilise correctement « some » ?", ["Some people love jazz.", "Some person love jazz.", "Some peoples love jazz.", "Any people love jazz."], "Some people love jazz."),
        ],
      },
    ],
  },
    ...
    lessons: [
      ...
      },
      {
        ...
        exercises: [
          ...
          MC("Read: « Anna hasn't called me back yet. » — Anna…", ["n'a pas encore rappelé", "a déjà rappelé", "ne rappellera jamais", "a laissé un message"], "n'a pas encore rappelé"),
          MC("Le comparatif de « far » est :", ["further", "farther", "more far", "most far"], "further"),
          MC("« I ___ never tried sushi. »", ["have", "had", "am", "did"], "have", "present perfect"),
          MC("« She's been waiting ___ two hours. »", ["for", "since", "during", "from"], "for", "durée"),
          MC("Quel mot complète : « It ___ two hours to drive there. »", ["takes", "makes", "does", "goes"], "takes"),
        ],
      },
      {
        title: "QCM difficiles",
        exercises: [
          ...
          MC("Quelle phrase est correcte ?", ["She used to live in Lyon.", "She use to live in Lyon.", "She was used to live in Lyon.", "She is used to lived in Lyon."], "She used to live in Lyon."),
          MC("« a flat » en anglais britannique est :", ["un appartement", "une maison", "un pneu crevé", "une batterie"], "un appartement"),
          MC("Quelle phrase exprime un futur certain ?", ["I'm meeting her at noon.", "I may meet her.", "I could meet her.", "I should meet her."], "I'm meeting her at noon.", "present continu = plan fixé"),
          MC("« no longer » signifie :", ["ne plus", "plus longtemps", "non plus", "pas encore"], "ne plus"),
          MC("« She ___ home when I called. »", ["had just arrived", "has just arrived", "just arrived", "will arrive"], "had just arrived", "action avant une autre au passé"),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          MC("« to be fed up » signifie :", ["en avoir marre", "être repu", "être fatigué", "s'ennuyer"], "en avoir marre"),
          MC("« meanwhile » signifie :", ["pendant ce temps", "parfois", "bientôt", "autrefois"], "pendant ce temps"),
          MC("« to raise a child » :", ["élever un enfant", "soulever un enfant", "adopter un enfant", "garder un enfant"], "élever un enfant"),
          MC("« furious » est plus fort que :", ["angry", "happy", "sad", "calm"], "angry"),
          MC("Le contraire de « to succeed » :", ["to fail", "to win", "to try", "to stop"], "to fail"),
        ],
      },
      {
        title: "QCM modérés",
